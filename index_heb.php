    ...
    ?>
            <div class="back_img">
                <div class="container">
                    <div class="caption pt-5">
                        <h3 class="font-weight-bold">הדרך המהירה, הזולה והקלה ביותר להזמין מסעדה בישראל</h3>
                        ...
                        <div class="form-group">
                            ...
                            <form method="POST" action="filter_results_heb.php?permission=true&lat=<?php echo $lat ?>&lon=<?php echo $lon; ?>">
                                <div class="row pt-4">
                                    <div class="col-md-2">
            ...
            <section>
                <div class="container item_section">
                    <h3 class="text-center"><span class="font-weight-bold">מסעדות לידך</span></h3>
                    <div class="row">
                        <?php
                ...
                if ($objRestaurant) {
                    ...
                    <section>
                        <div class="container item_section">
                            <h3 class="text-center"><span class="font-weight-bold">מסעדות</h3>
                            <div class="row">
                                <?php

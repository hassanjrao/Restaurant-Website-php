            ...
            <div class="row">
                <div class="col-md-5">
                    <form action="" method="post" data-parsley-validate>
                       ...
                       <a href="<?php echo $facebook_login_url ?>" class="btn btn-block btn-primary font-weight-bold btn-lg mt-4">Sign Up With
                        ...
                        <a href="<?php echo $loginURL ?>" class="btn btn-block btn-danger font-weight-bold btn-lg mt-4">Sign Up With Google</a>
                ...
                <div class="col-md-5">
                    <form action="" method="post" data-parsley-validate>
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-4"><input name="fname" type="text" class="form-control p-4 border-0 bg-light" placeholder="Firstname" required></div>
                            <div class="col-md-6 mt-4"><input name="lname" type="text" class="form-control p-4 border-0 bg-light" placeholder="Lastname" required></div>
                        </div>
                        <input type="email" name="email" class="form-control mt-4 p-4 border-0 bg-light" placeholder="Email Address" required>
                        <input type="text" name="phone" class="form-control mt-4 p-4 border-0 bg-light" placeholder="Phone Number" required>
                        <input type="password" name="password" id="passwordField" class="form-control mt-4 p-4 border-0 bg-light" placeholder="Password" data-parsley-minlength="6" required>
                        <input data-parsley-equalto="#passwordField" type="password" class="form-control mt-4 p-4 border-0 bg-light" placeholder="Confirm Password" required>

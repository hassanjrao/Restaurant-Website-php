...
class MenuDishEdit extends database
{
    ...
    public function updateItem()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "UPDATE menu_dish_tb SET dish_heb='$dish', price='$price', updated=CURRENT_TIMESTAMP where id='$id'";
            $res = mysqli_query($this->link, $sql);


            if ($res) {
                $msg = "success_upd";
                header("location: menu_dishes_heb.php?msg=$msg");
                return true;
            } else {
                $msg = "fail_upd";
                header("location: menu_dishes_heb.php?msg=$msg");
                                    ...
                                    <form action="" method="post">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">שם מנה עיקרית
                                            ...
                                            <div class="modal-body bg-light">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input type="text" name="name" value="<?php echo $row["dish_heb"] ?>" class=" form-control" placeholder="שם" required>
                                                    </div>
                                                    <div class="col-md-6">

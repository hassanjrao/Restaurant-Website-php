...
class MenuDishEdit extends database
{
    ...
    public function updateItem()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($lang == "english") {
                $sql = "UPDATE menu_dish_tb SET dish_en='$dish', dish_heb=NULL, price='$price', updated=CURRENT_TIMESTAMP where id='$id'";
                $res = mysqli_query($this->link, $sql);
            }
            else if ($lang == "hebrew") {
                $sql = "UPDATE menu_dish_tb SET  dish_en=NULL, dish_heb='$dish', price='$price', updated=CURRENT_TIMESTAMP where id='$id'";
                $res = mysqli_query($this->link, $sql);
            }
                                    ...
                                    <form action="" method="post">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body bg-light">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="lang" class="border-0 form-control" required>
                                                            <option selected value="<?php echo $row["dish_en"] !== NULL ? "english" : "hebrew" ?>"><?php echo $row["dish_en"] !== NULL ? "English" : "Hebrew" ?></option>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input type="text" name="name" value="<?php echo $row["dish_en"] != NULL ? $row["dish_en"] : $row["dish_heb"]; ?>" class="border-0 form-control" placeholder="Name" required>
                                                    </div>
                                                    <div class="col-md-6">

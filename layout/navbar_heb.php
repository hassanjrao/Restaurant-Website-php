    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container">
            ...
            if (isset($_GET["permission"]) && $_GET["permission"] == "true") {
                ...
                $lon = $_GET["lon"];
            ?>
                <a class="navbar-brand font-weight-bold" style="font-family: 'Lato', sans-serif; color: #481639" href="<?php echo "index_heb.php?permission=true&lat=" . $lat . "&lon=" . $lon ?>"><img src="images/logo.png" alt=""></a>

            <?php
            } else {
            ?>
                <a class="navbar-brand font-weight-bold" style="font-family: 'Lato', sans-serif; color: #481639" href="index_heb.php"><img src="images/logo.png" alt=""></a>

    ...
    ?>
                ...
                <div class="container">
                    <div class="caption pt-5">
                        ...
                        <div class="form-group">
                            ...
                            <form method="POST" action="filter_results_fr.php?permission=true&lat=<?php echo $lat ?>&lon=<?php echo $lon; ?>">
                                <div class="row pt-4">
                                    <div class="col-md-2">
            ...
            <section>
                <div class="container item_section">
                    <h3 class="text-center"><span class="font-weight-bold">Restaurants près de chez vous</span></h3>
                    <div class="row">
                        <?php
                ...
                if ($objRestaurant) {
                    ...
                    <section>
                        <div class="container item_section">
                            <h3 class="text-center"><span class="font-weight-bold">Restaurants</h3>
                            <div class="row">
                                <?php
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <?php if (isset($_GET["permission"]) && $_GET["permission"] == "true") {
                                    ...
                                    $lon = $_GET["lon"];
                                ?>
                                    <form action="filter_result_spec_fr.php?permission=true&lat=<?php echo $lat ?>&lon=<?php echo $lon ?>" method="POST">
                                    <?php
                                } else {
                                    ?>

    ...
    <form action="" method="post">
        <section>
            <div class="container bg-white pr-4 pl-4 log_section pb-5 reserve_section">
                <h5 class=" text-center pt-5 font-weight-bold"><?php echo "Thanks for your reservation " . ucfirst($rowCont["fname"]) . " " . ucfirst($rowCont["lname"]) . " for " . $_SESSION["people"] . " people on " . $_SESSION["date"];  ?></h5>
                ...
                <div class="container">
                    <div class="row pt-5">
                        ...
                        <div class="col-md-4 p-5 bg-light">
                            ...
                            <?php } else { ?>
                                <input type="text" name="code" class="form-control border-0 bg-white mt-5" placeholder="Reservation Code" value="" readonly required>
                            <?php } ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="container reserve_section_btn">
                <div class="row">
                    ...
                    <div class="col-md-6 pt-3">
                        <button type="submit" name="confirm" class="btn color_btn btn-block btn-lg font-weight-bold">Confirm My Reservation</button>
                    </div>
                </div>
            </div>
        </section>
